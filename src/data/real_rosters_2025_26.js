// Compatibility shim: prefer archived per-team JSONs or load archived JS if needed.
// Created 2025-11-14 to reduce single-file data size. The original roster data
// lives in archive/data/real_rosters_2025_26.js and per-team JSON files under
// data/rosters/. This shim ensures code that still includes the old path
// (`data/real_rosters_2025_26.js`) keeps working in both browser and Node.
// Compatibility shim: prefer archived per-team JSONs or load archived JS if needed.
// The original roster data was moved to archive/data/real_rosters_2025_26.js
// and per-team JSON files live under data/rosters/. This small shim preserves
// backwards compatibility for code that still imports `data/real_rosters_2025_26.js`.

(function () {
  // Node.js / tools: provide a global.window and require the archived JS so
  // legacy tools that `require('./data/real_rosters_2025_26.js')` continue to work.
  if (typeof window === 'undefined' && typeof global !== 'undefined') {
    ...
    try {
      ...
      try {
        console &&
          console.warn &&
          console.warn('Could not load archived real_rosters:', e && e.message);
      } catch (_) {
        /* ignore */
      }
    }
  ...
  // Browser: if rosters already present, do nothing
  try {
    if (
  ...
  // Otherwise insert the archived script synchronously so later scripts see
  // window.REAL_ROSTERS immediately (document.write is used intentionally).
  try {
    if (typeof document !== 'undefined' && typeof document.write === 'function') {
      try {
        document.write('<script src="archive/data/real_rosters_2025_26.js"><\\/script>');
      } catch (e) {
        // fallback to appendChild if document.write is unavailable for some reason
        let s = document.createElement('script');
        s.src = 'archive/data/real_rosters_2025_26.js';
        s.async = false;
    ...
    try {
      console && console.warn && console.warn('rosters shim failed to load archived file', err);
    } catch (_) {
      /* ignore */
    }
  }
...
window.REAL_ROSTERS["Real Madrid"] = [
  {
...
window.REAL_ROSTERS["Atletico de Madrid"] = [
  {
    "name": "Jan Oblak",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Real Betis"] = [
  {
    "name": "Álvaro Valles",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Real Sociedad"] = [
  {
    "name": "Álex Remiro",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Athletic Club"] = [
  {
    "name": "Unai Simón",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Valencia CF"] = [
  {
...
window.REAL_ROSTERS["Sevilla FC"] = [
  {
...
window.REAL_ROSTERS["FC Villarreal"] = [
  {
    "name": "Luiz Júnior",
    "position": "GK"
  },
...
window.REAL_ROSTERS["RCD Espanyol"] = [
  {
...
window.REAL_ROSTERS["Celta de Vigo"] = [
  {
    "name": "Ionuț Radu",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Rayo Vallecano"] = [
  {
...
window.REAL_ROSTERS["CA Osasuna"] = [
  {
    "name": "Sergio Herrera",
    "position": "GK"
  },
...
window.REAL_ROSTERS["RCD Mallorca"] = [
  {
    "name": "Leo Román",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Deportivo Alavés"] = [
  {
    "name": "Antonio Sivera",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Inter Milan"] = [
  {
    "name": "Josep Martínez",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Fiorentina"] = [
  {
    "name": "David de Gea",
    "position": "GK"
  },
...
window.REAL_ROSTERS["US Sassuolo"] = [
  {
    "name": "Arijanet Murić",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Pisa Sporting Club"] = [
  {
    "name": "Adrian Semper",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Hellas Verona"] = [
  {
...
window.REAL_ROSTERS["Sporting CP"] = [
  {
    "name": "Rui Silva",
    "position": "GK"
  },
...
window.REAL_ROSTERS["SL Benfica"] = [
  {
...
window.REAL_ROSTERS["FC Famalicao"] = [
  {
    "name": "Lazar Carević",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Rio Ave FC"] = [
  {
    "name": "Cezary Miszta",
    "position": "GK"
  },
...
window.REAL_ROSTERS["CD Santa Clara"] = [
  {
    "name": "Cezary Miszta",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Estoril Praia"] = [
  {
    "name": "Joel Robles",
    "position": "GK"
  },
...
window.REAL_ROSTERS["FC Alverca"] = [
  {
    "name": "André Gomes",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Gil Vicente FC"] = [
  {
    "name": "Andrew",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Casa Pia AC"] = [
  {
...
window.REAL_ROSTERS["Moreirense FC"] = [
  {
    "name": "André Ferreira",
    "position": "GK"
  },
...
window.REAL_ROSTERS["Vitoria SC"] = [
  {
    "name": "Juan Castillo",
    "position": "GK"
  },
...
window.REAL_ROSTERS["FC Arouca"] = [
  ...
  {
    "name": "Romualdas Jansonas",
    "position": "ST"
  }
];

window.REAL_ROSTERS["CD Tondela"] = [
  {
    "name": "Bernardo",
    "position": "GK"
  },
  ...
  {
    "name": "Yefrei Rodríguez",
    "position": "ST"
  }
];

window.REAL_ROSTERS["AVS Futebol SAD"] = [
  {
    "name": "João Gonçalves",
    "position": "GK"
  },
...
window.REAL_ROSTERS["CF Estrela Amadora"] = [
  {
    "name": "Diogo Pinto",
    "position": "GK"
  },
...
window.REAL_ROSTERS["CD Nacional"] = [
  {
    "name": "Lucas França",
    "position": "GK"
  },

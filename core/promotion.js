...
(function(){
  ...
  function cloneClubs(arr) { return arr.map(c => Object.assign({}, c)); }
  ...
  function applyPromotionRelegation(allDivisions) {
    if (!Array.isArray(allDivisions) || allDivisions.length === 0) throw new Error('allDivisions must be an array of divisions');
  ...
  // Export
  if (typeof module !== 'undefined' && module.exports) module.exports = { applyPromotionRelegation };
